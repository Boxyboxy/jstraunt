...
export default function ReviewForm({ review, events, action, onSuccess }: ReviewFormProps) {
  ...
  return (
    <form action={formAction} className="space-y-4">
      ...
      <div>
        <label htmlFor="quote" className="block text-sm font-medium text-stone-700 mb-1">
          Review Quote
        </label>
        <textarea
          id="quote"
      ...
      <div>
        <label htmlFor="event_id" className="block text-sm font-medium text-stone-700 mb-1">
          Associated Event <span className="text-stone-400 font-normal">(optional)</span>
        </label>
        <select
          id="event_id"
          name="event_id"
      ...
      <div className="flex items-center gap-6">
        ...
        <label className="flex items-center gap-2 cursor-pointer">
          ...
          <input
            ...
            className="rounded border-stone-300 text-stone-900 focus:ring-stone-900"
          />
          <span className="text-sm text-stone-700">Visible on site</span>
        </label>
      </div>
